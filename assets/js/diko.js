...
/*
  ...
  <div id="dback-to-top" class="dback-to-top p-3 rounded shadow bgf">
    <i class="fs-2 fas fa-chevron-up"></i>
  </div>
*/
const btt = document.querySelectorAll('.dback-to-top');
btt.forEach(item => {
...
window.addEventListener("scroll", () => {
  ...
  if (btt.length > 0) {
    if (scrollOffset > 200) {
      DOM.addState('dback-to-top', 'open')
    } else
      DOM.remState('dback-to-top', 'open')
  }
